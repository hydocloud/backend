...
from models.api_response import LambdaResponse, DeviceGroupsList, DataModel, Message
...
def get_device_groups(
    ...
    try:
        ...
        m = DeviceGroupsList(
            deviceGroups=parse_obj_as(List[DeviceGroupsModelShort], page.object_list)
        )

        if len(m.deviceGroups) == 0:
            status_code = 404
